            ...
            <div>
                <div class="item" 
                    ...
                    <div v-if="item.type === 'ADD_FRIEND'">
                        ...
                        <button @click="removeNotification(id)">Отклонить</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
   ...
   computed: {
       ...
       ...mapState(['isLogin', 'notifications'])
   },
    // computed: {
    //    isLogin() {
   ...
   methods: {
       ...
       acceptFriend(id) {
           fetch(
               `//192.168.64.3/api/users/friend.php`,
               {
                    headers: {
                       'Content-Type': 'application/json'
                   },
       ...
       removeNotice(id) {
            fetch(
                `//192.168.64.3/api/notification.php?id=${this.notifications[id].id}`,
                {
                    headers: {
                        'Content-Type': 'application/json'
                    },
   ...
   mounted() {
       fetch(
           `//192.168.64.3/api/notification.php?id=${localStorage.getItem('id')}`,
           {
               headers: {
                    'Content-Type': 'application/json'
                }
